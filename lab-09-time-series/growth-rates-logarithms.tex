...
\usepackage{alltt} \usepackage[utf8]{inputenc}  \usepackage{url} \usepackage{pgfpages}
...
\begin{frame}
  ...
  \item Consider the wage gap in average earnings between African
    ...
    \begin{displaymath}
        \%\text{Difference}  = \frac{582 - 621}{621} =    -0.0628019 
    \end{displaymath}
...
\text{then }    y &= \log_b(x) \text{read: $y$ equals $\log$ base $b$ of $x$} \nonumber
  ...
  \begin{block}{Some common examples}
    ...
    For example, $\ln \SI{35}{} = 3.5553481 $ because $e^{ 3.5553481} = 35$
  \end{block}
...
{\centering \includegraphics[width=\maxwidth]{figure/econ104-logarithm1-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/econ104-logarithm2-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/econ104-logarithm3-1} 
...
\only<6>{
  \begin{align}
    \ln(11) - \ln(10) &= 0.0953102 \nonumber\\
    \ln(22) - \ln(20) &= 0.0953102 \nonumber\\
    \ln(33) - \ln(30) &= 0.0953102 \nonumber\\
    \ln(55) - \ln(50) &= 0.0953102 \nonumber\\
    \omit\rlap{True even for big numbers that are 10\% apart:} \nonumber\\
    \ln(55000) - \ln(50000) &= 0.0953102 \nonumber
  \end{align}
}
  ...
  \begin{frame}
    ...
    \begin{align}
      \scriptstyle      \ln(1 - 0.20) &= -0.2231436 \stackrel{?}{\approx} -0.20 \nonumber\\
      \scriptstyle      \ln(1 - 0.10) &= -0.1053605 \stackrel{?}{\approx} -0.10 \nonumber\\
      \scriptstyle      \ln(1 - 0.05) &= -0.0512933 {\approx} -0.05 \nonumber\\
      \scriptstyle      \ln(1 - 0.03) &= -0.0304592 {\approx} -0.03 \nonumber\\
      \scriptstyle      \ln(1 + 0.00) &= 0 \nonumber\\
      \scriptstyle      \ln(1 + 0.03) &= 0.0295588 {\approx} +0.03 \nonumber\\
      % \scriptstyle      \ln(1 + 0.05) &= log(1.05) {\approx} +0.05 \nonumber\\
      % \scriptstyle      \ln(1 + 0.10) &= log(1.10) \stackrel{?}{\approx} +0.10 \nonumber\\
      % \scriptstyle      \ln(1 + 0.15) &= log(1.15) \stackrel{?}{\approx} +0.15 \nonumber\\
      % \scriptstyle      \ln(1 + 0.20) &= log(1.20) \stackrel{?}{\approx} +0.20 \nonumber
  ...
  \begin{frame}
    ...
    \begin{block}{Key Lessons}
      \begin{itemize}
      \item Recursive expression of exponential growth at 6\%: $y_t = 1.06 y_{t-1}$
...
{\centering \includegraphics[width=\maxwidth]{figure/econ104-gdp-1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/econ104-log-gdp-1} 
