...
\end{verbatim}
\begin{alltt}
\hldef{(xbar} \hlkwb{<-} \hlkwd{mean}\hldef{(x)); (xvar} \hlkwb{<-} \hlkwd{var}\hldef{(x))}
\end{alltt}
\begin{verbatim}
## [1] 0.3217385
## [1] 0.5714534
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlkwd{Sys.time}\hldef{())}
\end{alltt}
\end{kframe}
\end{knitrout}
...
Here is the result of another coin toss.  The coin comes up heads again.
...
\begin{kframe}
\begin{alltt}
\hlkwd{stargazer}\hldef{(cars,} \hlkwc{title} \hldef{=} \hlsng{"Summary statistics"}\hldef{,} \hlkwc{label}\hldef{=} \hlsng{"tab:summary"}\hldef{)}
\end{alltt}
\end{kframe}
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Mon, Nov 10, 2025 - 05:22:35 PM
...
\begin{kframe}
\begin{alltt}
\hlkwd{stargazer}\hldef{(model1, model2, model3,} \hlkwc{title}\hldef{=}\hlsng{"Regression results"}\hldef{,} \hlkwc{label}\hldef{=}\hlsng{"tab:regression"}\hldef{)}
\end{alltt}
\end{kframe}
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Mon, Nov 10, 2025 - 05:22:35 PM
...
\hline \\[-1.8ex] 
 speed & 3.932$^{***}$ & 0.913 & 6.801 \\ 
  & (0.416) & (2.034) & (6.801) \\ 
  & & & \\ 
 I(speed \textasteriskcentered  speed) &  & 0.100 &  \\ 
  &  & (0.066) &  \\ 
  & & & \\ 
 I(speed$\hat{\mkern6mu}$2) &  &  & $-$0.350 \\ 
  &  &  & (0.500) \\ 
  & & & \\ 
...
\begin{kframe}
\begin{alltt}
\hlkwd{stargazer}\hldef{(model1, model2, model3,} \hlkwc{title}\hldef{=}\hlsng{"Regression results with new names"}\hldef{,} \hlkwc{label}\hldef{=}\hlsng{"tab:regression:newnames"}\hldef{)}
\end{alltt}
\end{kframe}
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
% Date and time: Mon, Nov 10, 2025 - 05:22:35 PM
...
Do the R code chunks work? You should be able to compile the \LaTeX{} document.
